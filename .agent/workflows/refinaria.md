---
description: Execute produção intelectual com A Refinaria (livros, papers, frameworks)
---
...
5. Consulte as Knowledge Bases conforme necessário:
   - `A_Refinaria/modules/Framework_Creator/knowledge_base/KB_famous_frameworks.md`
   - `A_Refinaria/modules/Framework_Creator/knowledge_base/KB_naming_patterns.md`
   - `A_Refinaria/modules/Framework_Creator/knowledge_base/KB_visual_templates.md`

6. Salve outputs em `A_Refinaria/outputs/{project_slug}/`

7. Após conclusão, pergunte se o usuário deseja:
   - Refinar o output
   - Gerar versões adicionais (Canvas, Whitepaper, etc.)
   - Integrar com El_Clonador (para criar clone do autor)
