...
- `expansion-packs/copy/agents/david-ogilvy.md` (objection_algorithms section)
- `expansion-packs/copy/agents/alex-hormozi.md` (objection_algorithms section)
- `expansion-packs/copy/agents/dan-kennedy.md` (objection_algorithms section)
