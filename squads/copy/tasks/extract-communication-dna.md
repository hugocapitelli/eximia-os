...
- `expansion-packs/copy/agents/david-ogilvy.md` (communication_dna section)
- `expansion-packs/copy/agents/dan-kennedy.md` (communication_dna section)
- `expansion-packs/copy/agents/gary-halbert.md` (communication_dna section)
