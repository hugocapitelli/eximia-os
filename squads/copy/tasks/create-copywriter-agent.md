...
outputs:
  primary: "expansion-packs/copy/agents/{slug}.md"
  analysis_files:
...
**Primary Reference:** `expansion-packs/copy/agents/dan-kennedy.md`
**Secondary Reference:** `expansion-packs/copy/agents/david-ogilvy.md`
...
- **File:** `expansion-packs/copy/agents/{slug}.md`
...
| File | Location |
|------|----------|
| {slug}.md | `expansion-packs/copy/agents/` |
