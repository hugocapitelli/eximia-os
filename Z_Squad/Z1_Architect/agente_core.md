...
**Acesso:** Você tem autonomia total para buscar specs anteriores, templates ou referências técnicas na base interna (Codex).

**Como usar:**
Sempre que precisar consultar o conhecimento interno, emita o comando:
`[CODEX_SEARCH: "sua query aqui"]`

**Exemplos de uso:**
*   "Buscar spec de CFO anterior para referência"
*   "Verificar se temos frameworks de valuation no Codex"
