...
- **context** (opcional): Contexto da conversa (historico, capitulo, turno)
...
tambem podem resultar em vantagens competitivas. Portanto, conclui-se que
a adocao de praticas sustentaveis e imperativa.
```
        ...
        "indicators": [
            {
                ...
                "description": "Detectado: 'E importante ressaltar', 'Nesse sentido', 'Ademais', 'Portanto, conclui-se'",
                "weight": 0.30
            },
            {
            ...
            },
            {
                ...
                "description": "Estrutura introducao-desenvolvimento-conclusao perfeita",
                "weight": 0.20
            },
            {
                "type": "impersonal_tone",
                "description": "Ausencia de expressoes pessoais",
                "weight": 0.15
            }
        ],
        "flag": "alta_probabilidade_texto_IA"
...
destruir tudo. Acho q o equilibrio e dificil. Na fazenda do meu tio
eles tentam fazer rotacao de cultura mas as vezes nao da certo.
```

**Output:**
```json
{
    "analysis_id": "analysis_20260112_104500_def",
    ...
    "observations": [
        ...
        "Hesitacoes presentes: 'Bom', 'Tipo'",
        "Experiencia pessoal: 'Na fazenda do meu tio'",
        "Abreviacoes tipicas de digitacao"
    ],
...
### Exemplo 3: Incerto (Texto Curto)

**Input:**
```
Acho importante considerar o impacto ambiental.
```

**Output:**
```json
{
    "analysis_id": "analysis_20260112_110000_ghi",
    ...
    "observations": [
        ...
        "Resposta superficial pode indicar baixo engajamento"
    ],

    "recommendation": "Texto muito curto para analise. Monitorar engajamento."
}
```
...
papel_no_sistema: "Agente ANALISTA"
