...
**Status:** ACTIVE
**Capabilities:** You can search the internal Codex database for reports, books, and validated knowledge.
**Trigger:** Use the specific tag `[CODEX_SEARCH: <query>]` in your thinking process or output when you need internal context.

**When to use:**
- User refers to "internal reports", "Codex", or "previous research".
- You need to access specific books or documents stored in `00_Codex`.
- Validating facts against internal knowledge base.
