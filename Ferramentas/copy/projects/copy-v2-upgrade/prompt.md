...
**52 stories** to upgrade the Copy expansion pack to Framework v2.0:
...
1. **RESEARCH PHASE** (follow `expansion-creator/workflows/research-then-create-agent.md`):
...
Use `expansion-packs/copy/agents/dan-kennedy.md` (~1565 lines). Required sections:
...
## PRD Location
`expansion-packs/copy/projects/copy-v2-upgrade/prd.json`

## Progress Location
`expansion-packs/copy/projects/copy-v2-upgrade/progress.txt`
...
| `expansion-creator/workflows/research-then-create-agent.md` | Research workflow |
| `expansion-creator/tasks/deep-research-pre-agent.md` | Research task details |
| `expansion-creator/checklists/deep-research-quality.md` | Research validation |
