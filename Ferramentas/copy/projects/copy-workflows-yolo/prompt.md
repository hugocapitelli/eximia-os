...
This project implements **YOLO Mode** (100% autonomous) workflows for the Copy expansion pack.

### Key References
- **Base Script:** `expansion-packs/ralph/scripts/ralph.sh` (351 lines)
- **Workflows Doc:** `expansion-packs/copy/docs/frameworks/07-WORKFLOWS.md`
- **Agents:** `expansion-packs/copy/agents/` (19 agents)
- **Tasks:** `expansion-packs/copy/tasks/` (48 tasks)
- **Checklists:** `expansion-packs/copy/checklists/` (15 checklists)
- **Templates:** `expansion-packs/copy/templates/` (19 templates)
...
- reference: expansion-packs/copy/agents/todd-brown.md
- reference: expansion-packs/copy/checklists/sugarman-30-triggers.md
- reference: expansion-packs/ralph/scripts/ralph.sh
- etc.
