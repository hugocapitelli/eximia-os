    ...
    <div className="flex h-screen w-full overflow-hidden bg-[#f8f9fa] font-sans">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative flex-col justify-center items-center bg-[#1c2d1b] overflow-hidden">
        ...
        <div className="absolute top-8 left-8 z-20 flex items-center gap-2">
          <img src={settings.login_logo_url} className="h-8 w-auto object-contain brightness-0 invert" alt="Logo" onError={(e) => e.currentTarget.style.display = 'none'} />
        </div>
        ...
        <div className="flex-1 flex flex-col justify-center items-center w-full px-6 sm:px-12 md:px-24">
          <div className="w-full max-w-md animate-in slide-in-from-bottom-8 fade-in duration-700 delay-100">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-2">
                <div className="flex justify-between items-center">
                  ...
                  <a className="text-sm font-medium text-gray-500 hover:text-[#1c2d1b] transition-colors" href="#">
                    Esqueci minha senha?
                  </a>
                </div>
            ...
            <div className="mt-6 text-center">
              <a className="text-sm text-gray-500 hover:text-[#1c2d1b] transition-colors underline decoration-gray-300 underline-offset-4" href="#">
