...
const SystemSettings: React.FC = () => {
    ...
    const [backups] = useState([
        { id: 1, name: 'backup_2025-12-27_03-00.sql.gz', size: '245 MB', date: '2025-12-27', status: 'success' },
        { id: 2, name: 'backup_2025-12-26_03-00.sql.gz', size: '243 MB', date: '2025-12-26', status: 'success' },
        { id: 3, name: 'backup_2025-12-25_03-00.sql.gz', size: '241 MB', date: '2025-12-25', status: 'success' },
    ]);

    // Mock para Performance
    const [perfStats] = useState({
        cacheHitRate: '94.3%',
        cacheSize: '1.2 GB / 4 GB',
        cpu: '32%',
        ram: '58%',
        disk: '24%',
    ...
    const handleLogoUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
        if (e.target.files && e.target.files[0]) {
            ...
            try {
                ...
                // Atualiza com URL permanente do storage
                ...
                <div className="max-w-6xl mx-auto flex flex-col gap-10">
                    ...
                    {activeTab === 'integrations' && (
                        <div className="grid grid-cols-1 gap-6 animate-in fade-in slide-in-from-right-4 duration-300">
                            ...
                            <div className="bg-white rounded-2xl border border-harven-border p-8 shadow-sm">
                                <h3 className="text-lg font-display font-bold text-harven-dark mb-6">Integrações de Sistema</h3>
                                <div className="space-y-6">
                                    {/* Moodle */}
                                    <div className="p-6 border border-harven-border rounded-xl bg-gray-50/50">
                                        <div className="flex items-center gap-3 mb-4">
                                            <div className="size-8 bg-orange-100 rounded flex items-center justify-center text-orange-600"><span className="material-symbols-outlined text-lg">school</span></div>
                                            <h4 className="font-bold text-harven-dark">Moodle LMS</h4>
                                        </div>
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            <div className="space-y-1">
                                                ...
                                                <input
                                                    ...
                                                    onChange={(e) => handleChange('moodle_url', e.target.value)}
                                                    placeholder="https://moodle.exemplo.edu.br"
                                                />
                                            </div>
                                            <div className="space-y-1">
                                                ...
                                                <input
                                                    ...
                                                    onChange={(e) => handleChange('moodle_token', e.target.value)}
                                                    placeholder="Token..."
                                                />
                                            </div>
                                        </div>
                                    ...
                                    <div className="p-6 border border-harven-border rounded-xl bg-gray-50/50">
                                        <div className="flex items-center gap-3 mb-4">
                                            <div className="size-8 bg-blue-100 rounded flex items-center justify-center text-blue-600"><span className="material-symbols-outlined text-lg">mail</span></div>
                                            <h4 className="font-bold text-harven-dark">Servidor de E-mail (SMTP)</h4>
                                        </div>
                        ...
                        <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                            <div className="bg-white rounded-2xl border border-harven-border p-8 shadow-sm">
                                ...
                                <div className="flex items-center justify-between p-6 bg-gray-50 border border-gray-100 rounded-xl mb-6">
                                    <div>
                                        <h4 className="font-bold text-harven-dark">Backup Automático</h4>
                                        <p className="text-xs text-gray-500">Executa backups periódicos do banco de dados.</p>
                                    </div>
                                    <div className="flex items-center gap-4">
                                        <select
                                ...
                                <div className="space-y-4">
                                            ...
                                            <tbody className="divide-y divide-gray-100">
                                                {backups.map(bkp => (
                                                    <tr key={bkp.id} className="text-sm hover:bg-gray-50/50">
                                                        ...
                                                        <td className="p-3 text-gray-500">{new Date(bkp.date).toLocaleDateString()}</td>
                                                        <td className="p-3 text-gray-500">{bkp.size}</td>
                                                        <td className="p-3 text-right flex justify-end gap-2">
                                                            <button className="text-blue-600 hover:text-blue-800 font-bold text-xs uppercase">Download</button>
                                                            <button className="text-red-600 hover:text-red-800 font-bold text-xs uppercase" onClick={() => alert("Funcionalidade Mockada: Restaurar")}>Restaurar</button>
                                                        </td>
                                                    </tr>
                                                ))}
                                            </tbody>
                                    ...
                                    <div className="pt-4 flex justify-end">
                                        <button className="bg-harven-dark hover:bg-black text-white px-4 py-2 rounded-lg text-xs font-bold uppercase transition-colors flex items-center gap-2">
                        ...
                        <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div className="bg-white rounded-2xl border border-harven-border p-6 shadow-sm flex flex-col items-center text-center">
                                    <span className="material-symbols-outlined text-4xl text-green-500 mb-2">speed</span>
                                    <h4 className="text-3xl font-bold text-harven-dark font-display">{perfStats.uptime}</h4>
                                ...
                                <div className="bg-white rounded-2xl border border-harven-border p-6 shadow-sm flex flex-col items-center text-center">
                                    ...
                                    <h4 className="text-3xl font-bold text-harven-dark font-display">{perfStats.ram}</h4>
                                    <p className="text-xs text-gray-400 font-bold uppercase mt-1">Uso de Memória</p>
                                </div>
                                <div className="bg-white rounded-2xl border border-harven-border p-6 shadow-sm flex flex-col items-center text-center">
                                    <span className="material-symbols-outlined text-4xl text-purple-500 mb-2">storage</span>
                                    <h4 className="text-3xl font-bold text-harven-dark font-display">{perfStats.cacheHitRate}</h4>
                                    <p className="text-xs text-gray-400 font-bold uppercase mt-1">Cache Hit Rate</p>
                                </div>
                            </div>
                                ...
                                <div className="space-y-4">
                                    <div className="p-4 bg-gray-50 rounded-xl flex justify-between items-center border border-gray-100">
                                        <div>
                                            ...
                                            <p className="text-xs text-gray-500">TTL: 3600s | Tamanho: {perfStats.cacheSize}</p>
                                        </div>
                                        <button className="text-red-500 border border-red-200 hover:bg-red-50 px-3 py-1.5 rounded-lg text-xs font-bold uppercase transition-colors" onClick={() => alert('Cache limpo!')}>
                                            Limpar Cache
                                        </button>
                                    </div>
                                    <div className="p-4 bg-gray-50 rounded-xl flex justify-between items-center border border-gray-100">
                                        <div>
                                            <h4 className="font-bold text-harven-dark">Assets Estáticos (CDN)</h4>
                                            <p className="text-xs text-gray-500">Imagens, CSS e JS minificados.</p>
                                        </div>
                                        <button className="text-blue-500 border border-blue-200 hover:bg-blue-50 px-3 py-1.5 rounded-lg text-xs font-bold uppercase transition-colors">
                                            Invalidar CDN
                                        </button>
                                    </div>
                                </div>
