...
const ContentCreation: React.FC = () => {
   ...
   const processFile = async (selectedFile: File) => {
      ...
      try {
         ...
         // Detect media type from response
         if (uploadResult.type) {
            setMediaType(uploadResult.type as any);
         }

         // Use extracted text from PDF/TXT for AI processing
         if (uploadResult.extracted_text) {
            console.log('DEBUG: Texto extraído do arquivo:', uploadResult.extracted_text.substring(0, 200) + '...');
   ...
   const startAIProcessing = async () => {
      ...
      try {
         ...
         console.log('DEBUG: Chamando IA com conteudo:', contentForAI.substring(0, 200) + '...');
         ...
         if (result.questions && result.questions.length > 0) {
            ...
            console.log('DEBUG: Perguntas formatadas:', formattedQuestions);
            setAiGeneratedQuestions(formattedQuestions);
         } else {
            console.warn('DEBUG: Nenhuma pergunta retornada pela IA');
         }
         ...
         console.warn('DEBUG: IA falhou, usando perguntas default');
   ...
   const saveContentAndQuestions = async (isAI: boolean = false, questionsFromAI: any[] = []) => {
      ...
      try {
         ...
         if (newContent && newContent.id) {
            ...
            console.log('DEBUG: Salvando perguntas:', questionsToSave);
