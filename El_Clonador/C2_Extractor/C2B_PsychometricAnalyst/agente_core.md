...
| **Kolb Learning Style** | Estilo de aprendizado experiencial | 1 de 4 tipos |
| **Enneagram Type** | Tipo de personalidade Enneagram | 1-9 + wing |
...
Identificar o estilo de aprendizado experiencial dominante.

#### Os 4 Estilos de Kolb

| Estilo | Eixos | Caracteristicas | Indicadores |
| :--- | :--- | :--- | :--- |
| **Diverger** | Feel + Watch | Reflexivo, empatico, brainstorming | "Preciso entender o contexto", observa antes de agir |
| **Assimilator** | Think + Watch | Teorico, logico, modelos abstratos | "A teoria e...", cria frameworks sem aplicar |
| **Converger** | Think + Do | Pratico, tecnico, solucoes | "Vamos fazer", aplica teoria em projetos |
| **Accommodator** | Feel + Do | Acao, intuicao, trial-and-error | "Aprendo fazendo", executa sem planejar |

#### Indicadores por Estilo

**DIVERGER (Sentir + Observar)**
- Prefere observar antes de participar
- Valoriza perspectivas multiplas
- Forte em brainstorming e geracao de ideias
- Sensivel a feedback emocional
- *Quote tipica:* "Deixa eu entender melhor primeiro"

**ASSIMILATOR (Pensar + Observar)**
- Cria modelos teoricos abstratos
- Prefere informacao logica e concisa
- Interessado em conceitos mais que pessoas
- Quer explicacoes precisas
- *Quote tipica:* "O modelo/framework seria..."

**CONVERGER (Pensar + Fazer)**
- Aplica teoria em projetos praticos
- Prefere solucoes tecnicas a interpessoais
- Orientado a resultados e sistemas
- Aprende aplicando em contexto real
- *Quote tipica:* "Como aplico isso agora?"

**ACCOMMODATOR (Sentir + Fazer)**
- Executa sem planejar muito
- Confia em intuicao e tentativa-erro
- Impaciente com teoria excessiva
- Prefere acao a analise
- *Quote tipica:* "Vou tentar e ver o que acontece"

#### Perguntas-Guia para Identificacao

1. Prefere entender a teoria antes de aplicar ou aprende fazendo?
2. Toma decisoes com base em logica ou intuicao/sentimento?
3. Observa e reflete antes de agir ou age e ajusta depois?
4. Cria frameworks teoricos ou projetos praticos?
5. Valoriza mais a precisao conceitual ou o resultado pratico?

---

### 4. Enneagram

Identificar o tipo de personalidade Enneagram (1-9) e wing.

#### Os 9 Tipos

| Tipo | Nome | Fear Core | Desire Core |
| :--- | :--- | :--- | :--- |
| 1 | The Reformer | Ser corrupto/defeituoso | Ser bom, ter integridade |
| 2 | The Helper | Ser indesejado, indigno de amor | Ser amado |
| 3 | The Achiever | Ser sem valor | Ser valioso e admirado |
| 4 | The Individualist | Nao ter identidade propria | Ser unico e autentico |
| 5 | The Investigator | Ser inutil/incapaz | Ser competente e capaz |
| 6 | The Loyalist | Ficar sem suporte/guia | Ter seguranca e suporte |
| 7 | The Enthusiast | Ser privado/sofrer | Ser satisfeito e contente |
| 8 | The Challenger | Ser controlado/vulneravel | Proteger a si mesmo |
| 9 | The Peacemaker | Perda, fragmentacao | Ter paz interior |

#### Wings
Cada tipo pode ter influencia do tipo adjacente:
- Exemplo: 5w4 = Investigador com influencia de Individualista (mais criativo)
- Exemplo: 5w6 = Investigador com influencia de Loyalist (mais analitico)
...
```json
{
  ...
  "kolb_learning_style": {
    "primary_style": "Converger",
    "confidence": 88,
    "axes": {
      "perception": "Abstract Conceptualization",
      "processing": "Active Experimentation"
    },
    "interpretation": "Aprende aplicando teoria em projetos praticos",
    "evidence": [
      {
        "quote": "Citacao exata",
        "source": "Podcast X",
        "indicator": "Prefere aplicacao pratica"
      }
    ]
  },
  ...
  "enneagram": {
    ...
    "name": "The Iconoclast",
    "confidence": 84,
    "core_fear": "Being useless, incompetent",
    "core_desire": "Be capable, understand reality",
    "interpretation": "Investigador com inclinacao criativa",
    "evidence": []
  },
  ...
  "composite_interpretation": {
    ...
    "under_stress": "Como se comporta sob pressao",
    "decision_speed": "Rapido/Moderado/Lento",
    "learning_approach": "Como aprende melhor"
  },
...
- [ ] **Kolb Learning Style identificado** (1 de 4 tipos)
- [ ] **Enneagram Type identificado** (1-9 + wing)
